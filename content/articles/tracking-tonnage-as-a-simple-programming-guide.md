---
title: "Tracking Tonnage As A Simple Programming Guide"
description: "A simple “north star” for barbell training when you’re tired of program-hopping..."
...
- Every lift has a [progress guide](https://www.strengthjourneys.xyz/progress-guide/squat) with a **session tonnage chart** and a 30-day average baked in. Not just the big four: front squats, rows, cleans and the rest of the [lift explorer](https://www.strengthjourneys.xyz/lift-explorer) all get one.
...
- And the [workout log](https://www.strengthjourneys.xyz/log) shows your tonnage **mid-session**. Every lift you log is compared with your 12-month average for that lift, so you know whether one more set is worth it before you rack the bar.

![Front squat sets in the Strength Journeys workout log with session tonnage compared to the 12-month average](/articles/tracking-tonnage-as-a-simple-programming-guide/image-3.webp)

### Keep score month to month

Weekly tonnage is great. Monthly tonnage is where the story shows up.

The [home dashboard](https://www.strengthjourneys.xyz/) has a card called **The Month in Iron**. It lines up this month against last month for each of the big four: sessions, tonnage lifted, and strength level.

Partway through the month it tells you which lifts are ahead of pace. If your squat is lagging in week two, you still have plenty of month left to catch it up.

![The Month in Iron dashboard card comparing this month with last month for sessions and big four tonnage](/articles/tracking-tonnage-as-a-simple-programming-guide/image-4.webp)
