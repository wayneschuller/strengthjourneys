...
The biggest addition since the last update is a much more useful [AI lifting assistant](/ai-lifting-assistant). You can now ask for feedback directly from the parts of Strength Journeys you’re already exploring, with your relevant training data included automatically.
...
- A recent workout
- The session you’re viewing in the [workout log](/log)
- A specific lift and its visible sets
- Training patterns shown on your dashboard

[![The Week in Iron card with an AI review button](/changelog/2026-07-10/image-1.webp)](/)
...
Big Four lifts mentioned in responses can take you directly to the matching [lift page](/progress-guide).
...
[![Monthly heatmap in The Long Game card with a week-by-week tooltip](/changelog/2026-07-10/image-2.webp)](/)
...
The [1,000 lb Club calculator](/1000lb-club-calculator) now shows which recent sets were used to estimate your best squat, bench press and deadlift.
...
If you preview [imported training history](/import) without merging it into your own Sheet, Strength Journeys now gives you a clearer reminder on the home dashboard.
