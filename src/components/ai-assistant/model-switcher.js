...
/**
 * Inline provider marks, so the header needs no third-party image requests.
 *
 * @param {{ provider: "xai"|"openai", className?: string }} props
 */
export function ProviderLogo({ provider, className = "" }) {
  ...
  return (
    <svg viewBox="0 0 841.89 595.28" fill="currentColor" className={className} aria-hidden="true">
