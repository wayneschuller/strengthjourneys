...
// Recharts is the heaviest dependency this page can reach, and the timeline only
// appears for signed-in lifters with enough history to plot. Loading it on demand
// keeps it out of the bundle for everyone arriving from search.
const PercentileTimelineChart = dynamic(
  () => import("@/components/strength-circles/percentile-timeline-chart"),
  {
    ssr: false,
    loading: () => (
